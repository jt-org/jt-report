...
public class Utility4Test {
	...
	public static TestMethodResult createTestMethodResult() {
		final TestMethodResult tMr = new TestMethodResult(null, Utility4Test.class.getName(), "createDatasourceTest",
				"Data source cration utils test", "Expectations", new DateTime(), StateTestEnum.PASSED, null, 0.0, null);
		return tMr;
	}
